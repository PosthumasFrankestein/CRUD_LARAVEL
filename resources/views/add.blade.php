            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="">
                        @csrf
                        <div class="row mb-3">
                            <label for="name" class="col-md-4 col-form-label text-md-end">{{ __('LecturName') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <select name="faculty" id="faculty" class="form-control input-lg dynamic" onchange="loadModule(this.value)" data-dependent="module" required>
